...
export const info =
{
    ...
    conclusion: 'A compreensão da diferença de potencial na geração de raios é fundamental não apenas para entendermos os fenômenos atmosféricos, mas também para aprimorarmos nossa capacidade de prever e diminuir os impactos das tempestades elétricas. À medida que a ciência avança, novas tecnologias e métodos de monitoramento nos permitem melhorar os sistemas de alerta precoce e implementar medidas de segurança mais eficazes e, com isso, continuar avançando em direção a um futuro mais seguro diante dos desafios naturais eminentes.',
    conclusion_link: 'http://www.inpe.br/webelat/homepage/menu/el.atm/como.se.formam.os.raios.php'
}
...
export const card = [
    ...
    },
    {
        ...
        position: 'top-[40%] sm:top-[46%] xl:top-[42%] left-[36%] md:left-[44%]'
    },
    {
        id: 4,
        title: 'Ar ionizado',
