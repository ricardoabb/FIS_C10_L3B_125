...
export function Pin({ id, title = "", content = "", position }: textInfoProp) {
    ...
    return (
        <div key={id!} className={`pin absolute ${position} flex justify-center items-center  w-[2.5em] h-[2.5em] p-[2px] rounded-full bg-transparent border-2 border-orange-500 z-20`}>
